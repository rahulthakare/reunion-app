...
export default function LoginPage() {
  ...
  function friendlyError(err: unknown): string {
    ...
    // Surface common Firebase Auth errors verbatim
    ...
    if (raw.includes("auth/api-key-not-valid"))
      return "Firebase config is invalid. Check NEXT_PUBLIC_FIREBASE_API_KEY.";
    if (raw.includes("auth/network-request-failed"))
      return "Network error reaching Firebase. Check your internet connection.";
    if (raw.startsWith("Session:"))
      return raw; // server-side error from createSession
    // Fallback — show the raw error so we can debug
